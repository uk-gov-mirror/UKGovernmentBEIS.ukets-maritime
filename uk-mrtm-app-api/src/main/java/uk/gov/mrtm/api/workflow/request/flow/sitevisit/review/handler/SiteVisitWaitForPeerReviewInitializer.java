...
@Service
@AllArgsConstructor
public class SiteVisitWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return mapper.toApplicationReviewRequestTaskPayload(
            requestPayload,
            MrtmRequestTaskPayloadType.SITE_VISIT_WAIT_FOR_PEER_REVIEW_PAYLOAD,
    ...
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.SITE_VISIT_WAIT_FOR_PEER_REVIEW);
    }
}
