...
public class SiteVisitRejectedGenerateOfficialNoticeHandler implements JavaDelegate {

    private final SiteVisitOfficialNoticeService siteVisitOfficialNoticeService;

    @Override
    public void execute(DelegateExecution execution) {
        siteVisitOfficialNoticeService.generateRejectedOfficialNotice((String) execution.getVariable(BpmnProcessConstants.REQUEST_ID));
    }
}
