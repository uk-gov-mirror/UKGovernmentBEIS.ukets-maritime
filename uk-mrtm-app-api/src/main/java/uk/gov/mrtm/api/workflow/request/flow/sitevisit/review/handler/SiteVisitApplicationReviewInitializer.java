...
public class SiteVisitApplicationReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public Set<String> getRequestTaskTypes() {
        return Set.of(MrtmRequestTaskType.SITE_VISIT_APPLICATION_REVIEW);
    }
}
