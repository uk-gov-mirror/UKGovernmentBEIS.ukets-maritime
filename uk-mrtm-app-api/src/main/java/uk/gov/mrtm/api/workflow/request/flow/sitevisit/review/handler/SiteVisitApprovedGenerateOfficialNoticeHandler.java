...
public class SiteVisitApprovedGenerateOfficialNoticeHandler implements JavaDelegate {

    private final SiteVisitOfficialNoticeService siteVisitOfficialNoticeService;

    @Override
    public void execute(DelegateExecution execution) {
        siteVisitOfficialNoticeService.generateApprovedOfficialNotice((String) execution.getVariable(BpmnProcessConstants.REQUEST_ID));
    }
}
