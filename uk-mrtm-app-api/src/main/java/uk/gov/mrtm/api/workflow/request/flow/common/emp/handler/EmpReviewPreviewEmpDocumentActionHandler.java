...
public class EmpReviewPreviewEmpDocumentActionHandler implements
    ...
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType,
		...
		requestTaskPayload.getPreviewFiles().put(RequestGeneratedFileType.EMP,
    ...
    public List<String> getTypes() {
		return List.of(MrtmRequestTaskActionType.EMP_ISSUANCE_REVIEW_PREVIEW_EMP_DOCUMENT,
