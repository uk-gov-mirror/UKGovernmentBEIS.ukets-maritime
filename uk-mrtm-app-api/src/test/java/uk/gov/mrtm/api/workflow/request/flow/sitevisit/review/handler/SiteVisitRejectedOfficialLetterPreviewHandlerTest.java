...
class SiteVisitRejectedOfficialLetterPreviewHandlerTest {

    @InjectMocks
    private SiteVisitRejectedOfficialLetterPreviewHandler handler;
    ...
    void generateDocument_usesTaskReviewDecisionWithoutMutatingRequestPayload() {
        ...
        final SiteVisitReviewDecision reviewDecision = SiteVisitReviewDecision.builder()
            ...
            .details(SiteVisitReviewDecisionDetails.builder().summary("Rejected summary").build())
            .build();
        ...
        when(siteVisitOfficialNoticeService.doGenerateOfficialNoticeWithoutSave(
            ...
            eq(MrtmDocumentTemplateType.SITE_VISIT_REJECTED),
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(MrtmDocumentTemplateType.SITE_VISIT_REJECTED);
    }
