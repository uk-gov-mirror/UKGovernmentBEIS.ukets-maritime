...
class SiteVisitApprovedGenerateOfficialNoticeHandlerTest {

    @InjectMocks
    private SiteVisitApprovedGenerateOfficialNoticeHandler handler;
    ...
    void execute() {
        ...
        verify(siteVisitOfficialNoticeService).generateApprovedOfficialNotice(requestId);
