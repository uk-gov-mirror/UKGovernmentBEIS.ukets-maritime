...
class SiteVisitApplicationReturnedForAmendsCustomMapperTest {

    @InjectMocks
    private SiteVisitApplicationReturnedForAmendsCustomMapper cut;
    ...
    void toRequestActionDTO_accept_or_reject(SiteVisitReviewDecisionType type) {
        RequestAction requestAction = RequestAction.builder()
            ...
            .payload(SiteVisitApplicationReturnedForAmendsRequestActionPayload.builder()
        ...
        assertThat(result.getPayload()).isInstanceOf(SiteVisitApplicationReturnedForAmendsRequestActionPayload.class);

        SiteVisitApplicationReturnedForAmendsRequestActionPayload resultPayload = (SiteVisitApplicationReturnedForAmendsRequestActionPayload) result.getPayload();
    ...
    void getRequestActionType() {
        assertThat(cut.getRequestActionType()).isEqualTo(MrtmRequestActionType.SITE_VISIT_APPLICATION_RETURNED_FOR_AMENDS);
    }
