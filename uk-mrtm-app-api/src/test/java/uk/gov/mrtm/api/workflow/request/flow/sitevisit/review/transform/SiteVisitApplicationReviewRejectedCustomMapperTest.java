...
class SiteVisitApplicationReviewRejectedCustomMapperTest {

    @InjectMocks
    private SiteVisitApplicationReviewRejectedCustomMapper cut;
    ...
    void getRequestActionType() {
        assertThat(cut.getRequestActionType()).isEqualTo(MrtmRequestActionType.SITE_VISIT_APPLICATION_REJECTED);
    }
