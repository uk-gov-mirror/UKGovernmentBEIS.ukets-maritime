...
class SiteVisitApplicationPeerReviewInitializerTest {

    @InjectMocks
    private SiteVisitApplicationPeerReviewInitializer initializer;
    ...
    void getRequestTaskTypes() {
        assertEquals(initializer.getRequestTaskTypes(), Set.of(MrtmRequestTaskType.SITE_VISIT_APPLICATION_PEER_REVIEW));
    }
}
