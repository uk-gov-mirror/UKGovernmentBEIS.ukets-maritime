...
class EmpReviewPreviewOfficialDocumentActionHandlerTest {

	@InjectMocks
    private EmpReviewPreviewOfficialDocumentActionHandler cut;
    ...
    void process() {
		...
		assertThat(requestTaskPayload.getPreviewFiles().get(RequestGeneratedFileType.OFFICIAL_NOTICE)).isEqualTo(
	...
	void getTypes() {
		assertThat(cut.getTypes())
			.containsExactly(MrtmRequestTaskActionType.EMP_ISSUANCE_REVIEW_PREVIEW_OFFICIAL_DOCUMENT,
