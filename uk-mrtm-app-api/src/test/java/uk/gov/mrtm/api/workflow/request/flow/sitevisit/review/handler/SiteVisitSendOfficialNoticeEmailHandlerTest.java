...
class SiteVisitSendOfficialNoticeEmailHandlerTest {

    @InjectMocks
    private SiteVisitSendOfficialNoticeEmailHandler handler;
    ...
    void execute() {
        ...
        verify(siteVisitOfficialNoticeService).sendOfficialNotice(requestId);
